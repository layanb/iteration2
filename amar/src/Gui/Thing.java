...
public class Thing extends PApplet {
	...
	public int flag1 = 0, flag = 0, numcards = 0, flag2 = 0;
	...
	public void draw() {
		 ...
		 * Deal button 
		 *oop singletond :D 
		 *we want the deal button to act one time so we change his value to be 1 
		 * 
		 * */
		...
		/*
		 * HIT Button 
		 * we claimed that the player will have no more than 4 cards in his hand before he exceed the 21 
		 * and we added the flags from the deal button and the stand to make the button disabled after stand and enable after deal
		 * 
		 * */
 ...
 * call the stand function and check how many cards the dealer have and fill the cards
 * 
 * 
 * */
	...
	public String getimg(String x)
	{
		...
		/*
		 URL imgUrl = getClass().getClassLoader().getResource("pics/"+"Table.png");
	    ImageIcon icon = new ImageIcon(imgUrl);
